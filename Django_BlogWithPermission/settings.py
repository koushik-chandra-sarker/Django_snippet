"""
Django settings for Django_BlogWithPermission project.
...
ROOT_URLCONF = 'Django_BlogWithPermission.urls'
...
WSGI_APPLICATION = 'Django_BlogWithPermission.wsgi.application'
